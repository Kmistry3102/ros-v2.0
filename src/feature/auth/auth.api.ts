...
import { BasicDetails, OTPData } from "./auth.type";


export const sigupApi = async (data: BasicDetails) => {
...
export const sendOtpApi = async (data: BasicDetails) => {
...
export const sendEmailOtpApi = async (data: BasicDetails) => {
  const response = await apiRequest({
    method: "POST",
